...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,hIMtxHpnCnt = matrix( c(0,3,4,5  ,2,1,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL  ,rowReb = NULL  # c( rawMin=1 ,lowE=2 ,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(3,4,5  ,0,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL  ,rowReb = NULL
        ,hIMtxHpnCnt = matrix( c(1,2,3,4  ,2,2,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,hIMtxHpnCnt = matrix( c(0,1,4,5,6  ,0,1,2,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL        ,rowReb = NULL
        ,hIMtxHpnCnt = matrix( c(3,4  ,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL  ,rowReb = NULL  # c( rawMin=1 ,lowE=3 ,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(2,3,4,5  ,1,0,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL  ,rowReb = c( rawMin=2 ,lowE=3 ,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(2,3,4,5  ,1,0,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL  ,rowReb = c( rawMin=2 ,lowE=3 ,rareE=1 ,dupESum=2 )     # H802(2)
        ,hIMtxHpnCnt = matrix( c(3,4,5  ,1,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )  # H884(3)
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,hIMtxHpnCnt = matrix( c(3,4,5,6  ,3,1,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL        ,rowReb = c( rawMin=1 ,lowE=2,rareE=1 ,dupESum=2 )  # freqVal로 처리하긴 했는데... rawWin=2이 나으려나?
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL        ,rowReb = c( rawMin=1 ,lowE=2,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(3,4,5  ,2,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){ # done. OK
    HCRMtxCfg[[mName]] <- list(
        ...
        ,evtMax = NULL        ,rowReb = c( rawMin=2 ,lowE=2,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(3,4  ,1,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "F2szSumRebCnt"=list( rng=matrix( c(0,0 ,0,22) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3,3,3),c(16,17,18,19,20,21,22)) ,ncol=2)
                        ) 
            ,"S2szSumRebCnt"=list( rng=matrix( c(0,0 ,0,8) ,ncol=2 )
                            ,evt=matrix( c(c(2,3),c(7,8)) ,ncol=2)
                        )
            ,"F3szSumRebCnt"=list( rng=matrix( c(0,0 ,0,8) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3),c(4,5,6,7,8)) ,ncol=2)
                            ,forbidEvtReb=3
                        )
            ,"S3szSumRebCnt"=list( rng=matrix( c(0,0 ,0,8) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3),c(4,5,6,7,8)) ,ncol=2)
                            ,forbidEvtReb=3
                        )
            ,"F4szSumRebCnt"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(4,5,6)) ,ncol=2)
                            ,forbidEvtReb=3
                        )
            ,"S4szSumRebCnt"=list( rng=matrix( c(0,0 ,0,8) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3),c(4,5,6,7,8)) ,ncol=2)
                            ,forbidEvtReb=3
                        )
            ,"F5szSumRebCnt"=list( rng=matrix( c(0,0 ,0,13) ,ncol=2 )
                            ,evt=matrix( c(c(1,1,1,3,3,3),c(8,9,10,11,12,13)) ,ncol=2)
                        )
            ,"S5szSumRebCnt"=list( rng=matrix( c(0,0 ,0,9) ,ncol=2 )
                            ,evt=matrix( c(c(3,3),c(8,9)) ,ncol=2)
                        )
        )
        ,evtMax = matrix( c(2,2,3,2 ,2,2,3,2)     ,byrow=T ,ncol=4
        ...
        ,rowReb = c( rawMin=1 ,lowE=2 ,rareE=2 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(0,1,2,3,4,7,8  ,0,0,0,0,1,1,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "F2szSumRebDup"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(2,3,4,5)) ,ncol=2)
                            ,freqVal=1:2  ,forbidEvtReb=3
                        ) 
            ...
            ,"F5szSumRebDup"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                            ,freqVal=1
                        )
            ,"S5szSumRebDup"=list( rng=matrix( c(0,0 ,0,3) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(1,2,3,4)) ,ncol=2)  # H884(1)
                        )
        )
        ,evtMax = matrix( c(2,2,3,1 ,2,2,3,1)     ,byrow=T ,ncol=4
                    ,dimnames=list(c("lev1","lev2"),c("minLev","maxHpn","minLevH","maxHpnH")) 
        ...
        ,hIMtxHpnCnt = matrix( c(2,3,4  ,2,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) ) # H880
        ,isHard=NULL  # use default
    )
}
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "FsumTot1"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,1,3,3),c(3,4,5,6)) ,ncol=2)
                            ,freqVal=1:2
                        ) 
            ,"FsumTot2"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3),c(3,4,5)) ,ncol=2)
                        )
            ,"FsumTot3"=list( rng=matrix( c(0,0 ,0,4) ,ncol=2 )
                            ,evt=matrix( c(c(2,3),c(3,4)) ,ncol=2)
                        )
            ,"SsumTot1"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(4,5,6)) ,ncol=2)
                            ,freqVal=1:2
                        )
            ,"SsumTot2"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3),c(3,4,5)) ,ncol=2)
                        )
            ,"SsumTot3"=list( rng=matrix( c(0,0 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(1,2),c(1,2)) ,ncol=2)
                        )
        )
        ,evtMax = matrix( c(2,2,3,1 ,2,2,3,1)     ,byrow=T ,ncol=4
                    ,dimnames=list(c("lev1","lev2"),c("minLev","maxHpn","minLevH","maxHpnH")) 
        ...
        ,rowReb = c( rawMin=1 ,lowE=2 ,rareE=1 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(0,1,4,5,6  ,0,2,1,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        ...
        ,fCol = list(
            ...
            ,"FsumTot2"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,1,3,3),c(4,5,6,7)) ,ncol=2)
                        )
            ,"FsumTot3"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,3,3),c(4,5,6)) ,ncol=2)
                        )
            ,"SsumTot1"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3,3),c(3,4,5,6,7)) ,ncol=2)
            ...
            ,"SsumTot2"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,1,3,3),c(4,5,6,7)) ,ncol=2)
                        )
            ,"SsumTot3"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,3,3),c(4,5,6)) ,ncol=2)
                        )
        )
        ,evtMax = matrix( c(2,2,3,1 ,2,2,3,1)     ,byrow=T ,ncol=4
        ...
        ,rowReb = c( rawMin=1 ,lowE=2 ,rareE=2 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(0,1,2,5,6  ,0,0,1,3,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "FsumTot1"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(2,3,4,5)) ,ncol=2)
                            ,freqVal=1:2    ,forbidEvtReb=3
                        ) 
            ,"FsumTot2"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
            ...
            ,"FsumTot3"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3),c(1,2,3,4,5)) ,ncol=2)
                        )
            ,"SsumTot1"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(2,3,4,5)) ,ncol=2)
                            ,freqVal=1:2
                        )
            ,"SsumTot2"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
            ...
            ,"SsumTot3"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3,3),c(1,2,3,4,5)) ,ncol=2)
                        )
        )
        ,evtMax = matrix( c(2,2,3,1 ,2,2,3,1)     ,byrow=T ,ncol=4
        ...
        ,rowReb = c( rawMin=1 ,lowE=3 ,rareE=2 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(0,1,4,5,6  ,0,3,3,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )  # H866(0)
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "FsumTot1"=list( rng=matrix( c(0,0 ,0,3) ,ncol=2 )
                            ,evt=matrix( c(c(1,3,3),c(2,3,4)) ,ncol=2)
                            ,freqVal=1:2
                        ) 
            ,"FsumTot2"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                        )
            ,"FsumTot3"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3),c(1,2,3,4)) ,ncol=2)
                        )
            ,"SsumTot1"=list( rng=matrix( c(0,0 ,0,3) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                            ,freqVal=1  ,forbidEvtReb=3
                        )
            ,"SsumTot2"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                            ,freqVal=1
                        )
            ,"SsumTot3"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3,3),c(1,2,3,4)) ,ncol=2)
                            ,forbidEvtReb=3
                        )
        )
        ...
        ,rowReb = c( rawMin=1 ,lowE=2 ,rareE=2 ,dupESum=2 )
        ,hIMtxHpnCnt = matrix( c(0,4,5,6  ,2,0,0,0)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
...
if( TRUE ){
    HCRMtxCfg[[mName]] <- list(
        ...
        ,fCol = list(
            ...
            ,"FsumTot2"=list( rng=matrix( c(0,0 ,0,4) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(2,3,4,5)) ,ncol=2)
                            ,freqVal=1
                        )
            ,"FsumTot3"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
            ...
            ,"SsumTot2"=list( rng=matrix( c(0,0 ,0,4) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(2,3,4,5)) ,ncol=2)
                            # ,freqVal=1
                        )
            ,"SsumTot3"=list( rng=matrix( c(0,0 ,0,2) ,ncol=2 )
...
if( T ){
    HCRMtxCfg[[mName]] <- list(
        mName = mName   ,style=c( freqZero=TRUE )
        ,fCol = list(
            "F2sumTotHpn"=list( rng=matrix( c(0,0 ,1,6) ,ncol=2 )
                            ,evt=matrix( c(c(3,3,2,1),c(0,1,2,3)) ,ncol=2)
                            # ,freqVal=4:6
                        ) 
            ,"S2sumTotHpn"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,2),c(5,6)) ,ncol=2)
                            # ,freqVal=1:3
                        )
            ,"F3sumTotHpn"=list( rng=matrix( c(0,0 ,0,7) ,ncol=2 )
                            ,evt=matrix( c(c(1,3,3),c(0,6,7)) ,ncol=2)
                            # ,freqVal=2:4
                        )
            ,"S3sumTotHpn"=list( rng=matrix( c(0,0 ,0,6) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(3,4,5,6)) ,ncol=2)
                            # ,freqVal=1:2
                        )
            ,"F4sumTotHpn"=list( rng=matrix( c(0,0 ,0,4) ,ncol=2 )
                            ,evt=matrix( c(c(2,3),c(3,4)) ,ncol=2)
                            # ,freqVal=1
                        )
            ,"S4sumTotHpn"=list( rng=matrix( c(0,0 ,0,3) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3),c(2,3,4)) ,ncol=2)
                            # ,freqVal=1
                        )
            ,"F5sumTotHpn"=list( rng=matrix( c(0,0 ,0,5) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3),c(3,4,5)) ,ncol=2)
                            # ,freqVal=1
                        )
            ,"S5sumTotHpn"=list( rng=matrix( c(0,0 ,0,4) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3),c(2,3,4)) ,ncol=2)
                            # ,freqVal=1
                            ,forbidEvtReb=3
                        )
        ...
        ,rowReb = c( rawMin=1 ,lowE=3 ,rareE=2 ,dupESum=3 )
        ,hIMtxHpnCnt = matrix( c(0,1,2,3,4,5,8  ,0,0,0,0,1,2,2)   ,byrow=T  ,nrow=2  ,dimnames=list(c("hpnCnt","thld"),NULL) )
        # ,hIMtxValSum = matrix( c(5,6  ,1,1)   ,byrow=T  ,nrow=2  ,dimnames=list(c("valSum","thld"),NULL) )
        ,rowRebDupBan = matrix( c( TRUE, F ,1    ,TRUE ,F ,1 )   ,byrow=T ,nrow=2 ,dimnames=list(c("AA_A","AAB_B"),c("OnOff","freqVal","rawMin")) )
        ,isHard=NULL  # use default
    )
