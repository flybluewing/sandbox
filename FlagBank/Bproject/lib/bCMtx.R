...
crMName <- "crScrN03R"  # Cut-Result, Score N, Raw val only
if( TRUE ){

    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
        # hCRScr : cutRst1Score 히스토리. Rebound 체크 기능은 나중에 구현한다.

        rObj <- list( 	idStr=crMName  ,mName=c("scoreA","scoreB","scoreC","scoreD","scoreE","scoreF")
		)
...
crMName <- "crScrN03E"  # Cut-Result, Score N, Raw val only
if( TRUE ){
...
crMName <- "crScrN03PhEvt"  # phase 별로 evt 갯수 제한.(phase에서 다수 mName을 대상으로..)
if( TRUE ){
    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
        # hCRScr : cutRst1Score 히스토리. Rebound 체크 기능은 나중에 구현한다.
        rObj <- list( 	idStr=crMName  ,mName=c("scoreA","scoreB","scoreC","scoreD","scoreE","scoreF")
...
crMName <- "crScrN03Sum"  # Cut-Result, Score N, Raw val only.   "sfcLate" only
if( TRUE ){
    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
        # hCRScr : cutRst1Score 히스토리. Rebound 체크 기능은 나중에 구현한다.
...
crMName <- "crScrN04R"  # Cut-Result, Score N, Raw val only
if( TRUE ){
...
crMName <- "crScrN04E"  # Cut-Result, Score N, Raw val only
if( TRUE ){
...
crMName <- "crScrN04PhEvt"  # phase 별로 evt 갯수 제한.(phase에서 다수 mName을 대상으로..)
if( TRUE ){
    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
        # hCRScr : cutRst1Score 히스토리. Rebound 체크 기능은 나중에 구현한다.
        mName <- NULL
...
crMName <- "crScrN04Sum"  # Cut-Result, Score N, Raw val only.   "sfcLate" only
if( TRUE ){
    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
        # hCRScr : cutRst1Score 히스토리. Rebound 체크 기능은 나중에 구현한다.
        mName <- NULL
...
crMName <- "crScrN03SumClM"    # close max (for all hName)
if( TRUE ){
...
crMName <- "crScrN04SumClM"    # close max (for all hName)
if( TRUE ){
...
crMName <- "crScrN05SumClM"    # close max (for all hName)
if( TRUE ){
    #   .reportworkRpt/CutRstCLM_sumTotL.txt 참고
    bCMtxLst[[crMName]] <- function( hCRScr=NULL ){
