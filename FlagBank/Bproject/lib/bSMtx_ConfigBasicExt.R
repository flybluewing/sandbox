...
if( TRUE ){
    ...
    bsScrExtMtxCfg[[mName]]$filter03 <- list(
        ...
        ,fCol = list(
            ...
            ,"evt0.len.tot"=list( rng=matrix( c(0,1 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                        )
            ,"evt0.len.val"=list( rng=matrix( c(0,1 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(1,2,3,4)) ,ncol=2)
                        )
            ,"evt1.num"=list( rng=matrix( c(0,1 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(3,3),c(3,4)) ,ncol=2)
                        )
            ,"evt1.len.tot"=list( rng=matrix( c(0,1 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2)
                        )
            ,"evt1.len.val"=list( rng=matrix( c(0,1 ,0,1) ,ncol=2 )
                            ,evt=matrix( c(c(1,2,3,3),c(1,2,3,4)) ,ncol=2)
                        )
        )
