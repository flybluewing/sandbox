...
scoreMtxCfg[[mName]] <- list(
    ...
    ,fCol = list(
        ...
        ,"r.m2"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
        ...
        ,"sq.lma"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,3),c(1,2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq.lmt"=list( rng=matrix( c(NA,NA ,0,4) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,3),c(3,4,5,6)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq.lmaRem"=list( rng=matrix( c(NA,NA ,0,3) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,3),c(3,4,5,6)) ,ncol=2 ) # colname c("lev","val")
                    )
        ...
        ,"sq.ma"=list( rng=matrix( c(NA,NA ,0,3) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(1,2,3,3),c(1,2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq.mt"=list( rng=matrix( c(NA,NA ,0,6) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,4,4,4),c(3,4,5,6,7,8)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"c2.lm"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,4),c(2,3,4,5)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"c2.m2"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3,4),c(2,3,4,5)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"c2.mN"=list( rng=matrix( c(NA,NA ,0,1) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(3,3,3,3),c(1,2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq3.lma"=list( rng=matrix( c(NA,NA ,0,1) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(3,3,4,4),c(1,2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq3.lmt"=list( rng=matrix( c(NA,NA ,0,3) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
        ...
        ,"sq3.lmtRem"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
        ...
        ,"sq3.m2"=list( rng=matrix( c(NA,NA ,0,1) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(1,2,3,3,4),c(1,2,3,4,5)) ,ncol=2 ) # colname c("lev","val")
                    )
        ,"sq3.mt"=list( rng=matrix( c(NA,NA ,0,2) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
        ...
        ,"c3.lmt"=list( rng=matrix( c(NA,NA ,0,3) ,ncol=2 ,dimnames=list(c("min","max"),c("lev1","lev2")) )
                        ,evt=matrix( c(c(2,3,3),c(2,3,4)) ,ncol=2 ) # colname c("lev","val")
                    )
