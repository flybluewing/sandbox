...
analyLst[["toZ809"]] <- list(	stdFltCnt = 1
	...
	,fCutCnt.nextQuo10 = list(	commonCutCnt=3	# reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =1	,cStep =1	,fStep =0
				)
	,fCutCnt.nextBin = list(	commonCutCnt=0
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =1	# fCutU.spanMatch(stdMI$rawTail[5,],aZoid,posDiff=0 )
	...
	,fCutCnt.nextFStepBin = list(	commonCutCnt=4	 # reb2 rebCol quoPtn
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =0	,cStep =0	,fStep =0
				)
	,fCutCnt.nextColVal_1 = list(	commonCutCnt=0
					,auxZW=1	,auxQuo=0
					,raw =0	,rawFV =4	
						# 2*2 from fCutU.spanMatch(stdMI$rawTail[2,],aZoid,posDiff=1 )
					,rem =1	,cStep =1	,fStep =0
				)
...
analyLst[["toZ814"]] <- list(	stdFltCnt = 1
	...
	,fCutCnt.colValSeqNext =NA
	,fCutCnt.colValSeqNext.cStep =NA
	,fCutCnt.nextZW = list(	commonCutCnt=3	#  reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =3	# fCutU.spanMatch(stdMI$rawTail[4,],aZoid,posDiff=0 )
					,rem =1	,cStep =0	,fStep =0
				)
	...
	,fCutCnt.nextBin = list(	commonCutCnt=1	# rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
	...
	,fCutCnt.nextColVal_1 = list(	commonCutCnt=3	#  reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =2	,cStep =0	,fStep =0
				)
	,fCutCnt.nextColVal_2 = list(	commonCutCnt=0
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =5
						# 2 : neighborObj$matchCnt( aZoid )
						# 3 : fCutU.spanMatch(stdMI$rawTail[2,],aZoid,posDiff=-1 )
					,rem =0	,cStep =1	,fStep =0
				)
	,fCutCnt.nextColVal_3 = list(	commonCutCnt=0
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =2	# neighborObj$matchCnt( aZoid )
					,rem =1	,cStep =0	,fStep =0
				)
	...
	,fCutCnt.nextColVal_5 = list(	commonCutCnt=3	#  reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =1	,rawFV =0
					,rem =0	,cStep =0	,fStep =0
				)
...
analyLst[["toZ816"]] <- list(	stdFltCnt = 0
	...
	,fCutCnt.nextRebNum = list(	commonCutCnt=3	# reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =1	,cStep =1	,fStep =0
				)
	...
	,fCutCnt.nextFStepBin = list(	commonCutCnt=1	# rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =2	,cStep =1	,fStep =0
				)
	,fCutCnt.nextColVal_1 = list(	commonCutCnt=2	# reb2
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =0	,cStep =1	,fStep =0
				)
	...
	,fCutCnt.nextColVal_3 = list(	commonCutCnt=1	# rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =4	# 2* fCutU.hasPtn(c(18,19),aZoid)
										# 2  fCutU.spanMatch(stdMI$rawTail[5,],aZoid,posDiff=0 )
					,rem =1	,cStep =3	,fStep =0
				)
	,fCutCnt.nextColVal_4 = list(	commonCutCnt=3	# reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =0	,cStep =0	,fStep =0
				)
	...
	,fCutCnt.nextColVal_6 = list(	commonCutCnt=3	# reb2 rebCol
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =0	,cStep =1	,fStep =0
				)
...
analyLst[["toZ819"]] <- list(	stdFltCnt =2
	...
	,fCutCnt.nextBin = list(	commonCutCnt=3
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =1
					,rem =1	,cStep =0	,fStep =0
				)
	...
	,fCutCnt.nextCStepBin = list(	commonCutCnt=3
					,auxZW=0	,auxQuo=0
					,raw =1	,rawFV =0
					,rem =1	,cStep =1	,fStep =0
				)
	...
	,fCutCnt.nextColVal_1 = list(	commonCutCnt=1
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =0
					,rem =0	,cStep =0	,fStep =0
				)
	...
	,fCutCnt.nextColVal_4 = list(	commonCutCnt=2
					,auxZW=0	,auxQuo=0
					,raw =0	,rawFV =4
					,rem =2	,cStep =1	,fStep =0
				)
