...
fCut.hasPtn <- function( src ,tgt ){ # < official >
...
fCut.hasRow <- function( val ,mtx ){ # < official >
...
fCut.seqRebCnt <- function( pZh ,pZoid ,pRowLen=10 ,pLen=2 ){ # < official >
...
fCut.custStatic.nextZW <- function( gEnv ,allIdxF ){ # < official >
