...
cutEadge.getBanRebDiff <- function( gEnv ,allIdx ){
...
cutEadge.getBanSymCStep <- function( gEnv ,allIdx ){
...
cutEadge.getBanStepRebCStep <- function( gEnv ,allIdx ){
...
cutEadge.getBanGradCStep <- function( gEnv ,allIdx ){
